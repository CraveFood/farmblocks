...
<Preview>
  ...
  <Story name="Small">
    <Button onClick={action('onClick')} small>Small button</Button>
  </Story>
  <Story name="Active">
    <Button onClick={action('onClick')} active>Active button</Button>
  </Story>
</Preview>
...
<Preview>
  <Story name="Fluid">
    ...
    <br />
    <Button variant={buttonVariants.PRIMARY} fluid icon={<MdSettings size={22} />}>
      Primary With Icon
    </Button>
  </div>
  </Story>
...
<Preview>
  <Story name="With icon">
    <Button onClick={action('onClick')} icon={<MdSettings size={22} />}>Left Icon</Button>
  </Story>
  <Story name="With right icon">
    <Button onClick={action('onClick')} rightIcon={<SmChevronDown size={20} />}>Right Icon</Button>
  </Story>
  <Story name="With both icons">
    <Button onClick={action('onClick')} icon={<MdSettings size={22} />} rightIcon={<SmChevronDown size={20} />}>Both icons</Button>
  </Story>
</Preview>
  ...
  <Story name="Custom Theme">
    ...
    >
      <Button
        ...
        text="🦄 My Beautiful Primary Button"
      />
      <br />
      <Button
        variant='myVariant'
        onClick={action("buttonClicked")}
        text="🦄 My Beautiful Own Variant"
      />
    </ThemeProvider>
  </Story>
</Preview>
