...
const Vector = React.forwardRef(({ size, color, ...props }, ref) => (
  ...
  >
    <path
      d="M12.069 2C15.996 2 19 4.828 19 8.799c0 3.36-1.197 6.507-3.18 9.356a21.667 21.667 0 0 1-2.162 2.638l-.317.323-.144.142-.257.244-.111.101-.186.163a1 1 0 0 1-1.286 0l-.186-.163-.234-.216c-.043-.04-.087-.084-.134-.129l-.144-.142-.317-.323a21.667 21.667 0 0 1-2.163-2.638C6.197 15.305 5 12.159 5 8.799c0-3.888 2.88-6.68 6.687-6.795L12.07 2ZM12 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6Z"
      fill={color}
      fillRule="evenodd"
    />
  </svg>
